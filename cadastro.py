...
def janela_cadastro():
    ...
    mainmenu.add_command(label="Salvar", command=lambda: inserir_dados(entry_cpf.get(), entry_nome.get(),
                                                                       entry_sobrenome.get(), entry_email.get(),
                                                                       entry_telefone.get(), entry_senha.get(),
    ...
    label_sobrenome = Label(frame_down, text="Sobrenome:", font="Calibri 12 bold", width=14, anchor=E, fg=cor03,
                            bg=cor01)
    label_sobrenome.place(x=30, y=70)
    ...
    label_telefone.place(x=30, y=160)
    ...
    label_con_senha = Label(frame_down, text="Confirmar Senha:", font="Calibri 12 bold", width=16, anchor=E, fg=cor03,
                            bg=cor01)
    label_con_senha.place(x=15, y=295)
